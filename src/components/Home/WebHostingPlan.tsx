...
const WebHostingPlan = () => {
  return (
    <div className="flex flex-col items-center justify-center mb-7 lg:w-1/4 md:w-2/4 w-3/4 rounded p-4 bg-gray-200">
      <h3 className="text-3xl font-bold text-purple-900">Premium</h3>
      <strong className="text-3xl font-bold text-gray-900 my-5">
        $4.99/mo
      </strong>
      <span className="bg-red-200 rounded-full px-2 py-1 font-semibold">
        10% OFF
      </span>
      <div className="mt-6">
